    ...
    <table>
            ...
            <tbody>
                @forelse ($categories as $category)
                    <tr>
                        <td>
                            <strong style="color: var(--primary-green);">{{ $loop->iteration }}</strong>
                        </td>
                        <td>
                            @if ($category->image)
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <button type="button" class="btn-delete-ajax" data-url="{{ route('admin.categories.destroy', $category->id) }}" data-item-name="{{ $category->name }}" data-item-type="category">
